...
export let state: RootStateType = {
    ...
    dialogsPage: {
        dialogItem: [
            ...
            {id: 5, name: "Krusty the Clown", avatar: "https://whatsondisneyplus.com/wp-content/uploads/2021/09/krusty.png"},
            {id: 6, name: "Maggie Simpson", avatar: 'https://www.disneyplusinformer.com/wp-content/uploads/2021/09/The-Simpsons-Profile-Icons-6.png'},
            {id: 7, name: "Ralph Wiggum", avatar: 'https://www.disneyplusinformer.com/wp-content/uploads/2021/09/The-Simpsons-Profile-Icons-4.png'},
            {id: 8, name: "Dr. Hibbert", avatar: "https://www.disneyplusinformer.com/wp-content/uploads/2021/09/The-Simpsons-Profile-Icons-3.png"},
            {id: 9, name: "Ned Flanders", avatar: "https://static.wikia.nocookie.net/simpsons/images/2/2e/Season_23_Icon.jpg"},
            {id: 10, name: "Abraham Simpson II", avatar: "https://static.wikia.nocookie.net/simpsons/images/5/5f/Season_24_Icon.jpg"},
        ],
